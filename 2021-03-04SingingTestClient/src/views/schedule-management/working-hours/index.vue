...
export default {
  ...
  computed: {
    QueryToolApi() {
      return {
        GetResultApi: `${process.env.VUE_APP_BASE_API}/api/working-hours/GetList`,
        AddApi: null,
        ImportApi: `${process.env.VUE_APP_BASE_API}/api/working-hours/UpsertList`,
        EnabledInputList: [
    ...
    BaseTableApi() {
      return {
        EditApi: `${process.env.VUE_APP_BASE_API}/api/working-hours/UpsertList`,
        DeleteApi: null,
      };
    },
    writable() {
